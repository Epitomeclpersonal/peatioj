...
import org.peatio.app.PeatioApplication;
...
@SpringBootTest(classes = {PeatioApplication.class}, webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext
public class PeatioApplicationTests {
